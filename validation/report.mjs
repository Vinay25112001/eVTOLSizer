...
const HARNESSES = [
  ["scope-check.mjs",     "Every referenced identifier is imported, declared or a runtime global. Catches a whole class of silent breakage that a browser would only reveal on the code path a user happens to take."],
